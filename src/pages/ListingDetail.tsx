        ...
        <div className="detail-info">
          ...
          <div className="detail-meta">
            ...
            <div className="meta-item">
              ...
              <div className="meta-value">2 days ago</div>
            </div>
          </div>
          <div className="detail-actions">
            <button className="btn-primary" onClick={() => showToast('Order placed! Seller will be notified.')}>Buy Now — {listing.price} SAR</button>
